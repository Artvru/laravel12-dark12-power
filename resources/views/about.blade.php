...
@section('content')
    <div class="max-w-2xl mx-auto">
        <h1 class="text-3xl font-bold text-amber-500 mb-6 border-b border-gray-700 pb-2">📜 ประวัติศาสตร์</h1>
        <p class="text-gray-300 leading-relaxed mb-4">
             เพื่อก้าวข้ามผ่านลูปนรกและพิชิตสถาปัตยกรรม Laravel 12 ยุคใหม่ 
        ...
        <div class="mt-8 bg-gray-900 p-4 rounded-lg border border-amber-500/30">
            <h3 class="text-xl font-bold text-amber-400 mb-3">🛡️ชื่อสัตว์เฝ้าประตู (Data from Route):</h3>
