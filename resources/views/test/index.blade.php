        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <div class="bg-gray-900 p-4 rounded-lg border border-gray-700 hover:border-amber-500 transition shadow-md">
                ...
                <a href="/gallery/ant">
                    ...
                    <span class="text-lg font-semibold text-gray-200">Ant Page</span>
                </a>
            </div>
            ...
            <div class="bg-gray-900 p-4 rounded-lg border border-gray-700 hover:border-amber-500 transition shadow-md">
                <a href="/gallery/bird">
                    ...
                    <span class="text-lg font-semibold text-gray-200">Bird Page</span>
                </a>
            </div>
            ...
            <div class="bg-gray-900 p-4 rounded-lg border border-gray-700 hover:border-amber-500 transition shadow-md">
                <a href="/gallery/cat">
                    ...
                    <span class="text-lg font-semibold text-gray-200">Cat Page</span>
                </a>
            </div>
        </div>
    </div>
